 ...
 * scanline sheen and a 3D tilt: a plane you can pick up and turn in the light.
 * The rarity colour is the only hue, and the sheen strengthens with rarity, so
 * a legendary genuinely shines more than a common.
 */
  ...
  return (
    ...
    >
      ...
      <span className="cc__card">
        ...
        <span className="cc__layer cc__glare" aria-hidden="true" />
